...
describe("AI Agents Demo", () => {
    ...
    it("should run RAG agent with mock tool", async () => {
        console.log("--- TESTING RAG AGENT (Query: 'Who invented pizza?') ---");
        const messages = [
            { role: 'user', content: 'Who invented pizza according to the documents?' }
        ];
    ...
    it("should run Buddy personality", async () => {
    ...
    it("should run Sarcastic personality", async () => {
